...
- Close with a plain ask: "Happy to walk through the code." / "Would like to talk."
...
4. **Close** (1–2 sentences): plain ask. Sign with the first name from `profile/master.yaml: identity.name`.

Greeting: "Hi <Team> team," if team known; else "Hi <Company> team,". Never "Dear Hiring Manager".
