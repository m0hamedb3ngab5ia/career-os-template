...
Length: 120 to 250 words (`config/qa.yaml: cover_letter`). Greeting: `Hi <Team> team,` when the team
is known, else `Hi <Company> team,`. Sign with the candidate's first name (`profile/master.yaml: identity.name`).
...
greeting: "Hi Payments Infrastructure team,"
date: 2026-09-24
sign_off: "Alex"                    # first name from profile/master.yaml: identity.name
...
Must contain: a plain ask. "Happy to walk through the code." / "Would like to talk." Then the sign-off.
